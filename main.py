                ...
                while need_train:
                    ...
                    for it, (inputs, _) in enumerate(dataloader):
                        ...
                        if config.iter_sample and g_iteration % config.iter_sample == 0:
                            ...
                            torchvision.utils.save_image(fake_img,os.path.join(sample_dir,f'{g_iteration}_G.png'),normalize=True)
                            torchvision.utils.save_image(dis_real_img, f'{sample_dir}/{g_iteration}_D.png',normalize=True)
                            torchvision.utils.save_image(dis_fake_img, f'{sample_dir}/{g_iteration}_fake_D.png',normalize=True)
